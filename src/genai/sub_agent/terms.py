...
class TermsAgent:
    ...
    def _load_system_prompt():
        with open("/var/vpbank/datacontracts/sandbox/data/system_prompt/terms.txt", "r", encoding="utf-8") as fp:
            data = fp.read()
    ...
    def invoke(self, user_query):
        state = TermsAgentState(messages=[HumanMessage(content=user_query)])
