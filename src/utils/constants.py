...
RULESET_BUCKET_NAME = os.getenv("RULESET_BUCKET_NAME", None)
COGNITO_USER_POOL_ID = os.getenv("COGNITO_USER_POOL_ID", None)
COGNITO_APP_CLIENT_ID = os.getenv("COGNITO_APP_CLIENT_ID", None)
DATACONTRACT_MAPPING_DYNAMODB_TABLE_NAME = os.getenv(
    "DATACONTRACT_MAPPING_DYNAMODB_TABLE_NAME", None
)
DATACONTRACT_DYNAMODB_STATE_GSI_NAME = os.getenv(
    "DATACONTRACT_DYNAMODB_STATE_GSI_NAME", None
)
RULESET_MAPPING_DYNAMODB_TABLE_NAME = os.getenv(
    "RULESET_MAPPING_DYNAMODB_TABLE_NAME", None
)
RULESET_DYNAMODB_STATE_GSI_NAME = os.getenv("RULESET_DYNAMODB_STATE_GSI_NAME", None)
